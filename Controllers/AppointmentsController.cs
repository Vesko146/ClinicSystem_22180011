...
namespace ClinicSystem_22180011.Controllers
{
    public class AppointmentsController : Controller
    {
        ...
        public AppointmentsController(Clinic22180011Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("AppointId,PatientId,DoctorId,AppointmentDate,Status,LastModified22180011")] Appointment appointment)
        {
