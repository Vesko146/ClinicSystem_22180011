        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastModified_22180011 = table.Column<DateTime>(type: "datetime", nullable: true, defaultValueSql: "(getdate())"),
                    UserId = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Doctors__2DC00EDFD9124C4F", x => x.DoctorID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__log_2218__5E5499A83F1D9785", x => x.LogID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Patients__970EC346CD79073D", x => x.PatientID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Appointm__DCC1C95971A93C2F", x => x.AppointID);
                    table.ForeignKey(
                        name: "FK__Appointme__Docto__412EB0B6",
                        column: x => x.DoctorID,
                        principalSchema: "22180011",
                        principalTable: "Doctors",
                        principalColumn: "DoctorID");
                    table.ForeignKey(
                        name: "FK__Appointme__Patie__403A8C7D",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ExamDeta__135C314D1BC0F75F", x => x.DetailID);
                    table.ForeignKey(
                        name: "FK__ExamDetai__Appoi__44FF419A",
